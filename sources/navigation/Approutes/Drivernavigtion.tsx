...
import { Orderdetails, OrderHistory, Profile, Scan, ScanOrder, TripDetails } from '../../screens/DriverFlow';
...
const Drivernavigtion = () => {
  return (
     <Stack.Navigator screenOptions={{headerShown:false}}>
        ...
        <Stack.Screen component={TripDetails} name={NavRoutes.TRIPDETAILS}/>
    </Stack.Navigator>
  )
}
